...
public class CartOperation extends HttpServlet {
	...
	if (cart == null) {
        ...
        //get the session state, if no session, create a new cart;
        ...
        while (items.hasMoreElements()) {
            ...
            if (item.equals("Submit")) continue;
                ...
                //get the amcount of item, and then put it into map cart;
            }
	...
	for (String item : items) {
        ...
        out.println("<p> ----------------------------</p> ");
        out.println("<p> Following are the stuff in your cart</p> ");
